...
export const BASELINE = {
    ...
    commit: '005ca7741fb98c9793dc80ec28a703b3bc47fff1',
    path: 'clean gameinfo.gi/gameinfo.gi',
} as const;

const SqookyDefault: PerformancePreset = {
    id: 'sqooky-default',
...
const SqookyTesting: PerformancePreset = {
    id: 'sqooky-testing',
...
const BootMaxFps: PerformancePreset = {
    id: 'boot-max-fps',
    name: 'boot\'s Max FPS',
    version: '2.7',
    tier: 'aggressive',
...
const KaizuMinSpec: PerformancePreset = {
    id: 'kaizu-min-spec',
...
const OptilockFps: PerformancePreset = {
    id: 'optilock-fps',
    name: 'OptiLock FPS',
    version: '4.2',
    tier: 'competitive',
...
const OptilockMax: PerformancePreset = {
    id: 'optilock-max',
...
export const PRESETS: readonly PerformancePreset[] = [
    SqookyDefault,
    SqookyTesting,
    BootMaxFps,
    KaizuMinSpec,
...
export function getPreset(id: string | null | undefined): PerformancePreset {
