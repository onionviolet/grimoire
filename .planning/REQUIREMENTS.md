...
| REQ-packaged-fork-engine | Phase 2 | Complete as amended (D-02): pinned-SHA build-from-source substitutes for the checksum-pinned release promotion; release promotion deferred as future work |
| REQ-fork-support-destination | Phase 2 | Complete |
...
| REQ-portrait-journey-consolidation-gated | Phase 5 | Complete |
| REQ-portrait-alias-sweep | Phase 5 | Pending |
| REQ-ui-consequence-and-vocabulary | Phase 5 | Complete |
| REQ-browser-tool-catalog | Phase 6 | Pending |
| REQ-browser-produced-file-handoff | Phase 6 | Complete |
| REQ-browser-navigation-gaps | Phase 6 | Complete |
